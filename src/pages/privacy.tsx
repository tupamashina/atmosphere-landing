...
export default () => (
  <div
    className={bodyTypographyClass.lg}
    style={{
      maxWidth: 'calc(80ch + 2rem)',
      margin: '0 auto',
      padding: '2rem 1rem',
  ...
  >
    ...
    предпринимаемые ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ «АТМОСФЕРА», ООО
    &quot;АТМОСФЕРА&quot; (далее – Оператор).
    <br />
    ...
    получить о посетителях веб-сайта https://atm-itp.ru/
    <br />
    ...
    интернет по сетевому адресу https://atm-itp.ru/
    <br />
    ...
    к определенному или определяемому Пользователю веб-сайта https://atm-itp.ru/
    <br />
    ...
    <br />
    2.10. Пользователь – любой посетитель веб-сайта https://atm-itp.ru/
    <br />
    ...
    <br />– получать от субъекта персональных данных достоверные информацию
    ...
    <br />– получать информацию, касающуюся обработки его персональных данных,
    ...
    материалам, содержащимся на веб-сайте https://atm-itp.ru/
    <br />
    ...
    направив Оператору письмо на адрес электронной почты zakaz@atm-itp.ru с
    ...
    являются:
    <br />– перечислите нормативно-правовые акты, регулирующие отношения,
    связанные с вашей деятельностью, например, если ваша деятельность связана с
    информационными технологиями, в частности с созданием сайтов, то здесь можно
    указать Федеральный закон &quot;Об информации, информационных технологиях и
    о защите информации&quot; от 27.07.2006 N 149-ФЗ;
    <br />– уставные документы Оператора;
    <br />– договоры, заключаемые между оператором и субъектом персональных
    данных;
    <br />– федеральные законы, иные нормативно-правовые акты в сфере защиты
    персональных данных;
    <br />– согласия Пользователей на обработку их персональных данных, на
    ...
    формы, расположенные на сайте https://atm-itp.ru/ или направленные Оператору
    ...
    уведомление на адрес электронной почты Оператора zakaz@atm-itp.ru с пометкой
    ...
    почты на электронный адрес Оператора zakaz@atm-itp.ru с пометкой «Отзыв
    ...
    Оператору с помощью электронной почты zakaz@atm-itp.ru.
    <br />
    ...
    Интернет <strong>по текущему адресу https://atm-itp.ru/privacy.</strong>
  </div>
);
