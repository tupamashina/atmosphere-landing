...
export const blockTitleClass = style([
...
export const blockSubtitleClass = style([
...
export const blockFormClass = style({
  display: 'grid',
...
globalStyle(`${blockFormClass} ${textFieldLabelClass}`, {
  vars: {
    [textFieldLabelBackgroundColorVar]: themeVars.colors.primaryContainer,
  },
});

export const blockFormSubmitButtonClass = style({ alignSelf: 'end' });

export const blockFormTermsClass = style([
...
globalStyle(`${blockFormTermsClass} > a`, { color: 'inherit' });
